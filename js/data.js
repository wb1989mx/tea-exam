...
var TOOL_LIB = [
  ...
  { id: 'wd',  name: '温度计', icon: '🌡',  cup: false, gaiwan: false, desc: '干扰项：沸水冲泡无需测温' },
  ...
  { id: 'cc',  name: '茶宠',   icon: '🐉',  cup: false, gaiwan: false, desc: '干扰项：茶艺摆件' },
  { id: 'gd',  name: '公道杯', icon: '⚗',  cup: false, gaiwan: false, desc: '干扰项：非标准审评器具' },
  { id: 'cl',  name: '茶滤',   icon: '▦',  cup: false, gaiwan: false, desc: '干扰项：审评杯/盖碗自带滤孔' }
];
...
function genNormQuestions(teaKey, method) {
  ...
  if (method === 'cup') {
    A = [
      ...
      { id: 'a5', text: '审评方法：盖碗法（110mL盖碗）',              correct: false, desc: '干扰项：与所选器具不匹配' },
      { id: 'a6', text: '投茶量：5g',                                  correct: false, desc: '干扰项：5g为盖碗法投茶量' },
      { id: 'a7', text: '冲泡时间：3分钟',                             correct: false, desc: '干扰项：时间偏短' },
      { id: 'a8', text: '水温：85℃冲泡',                               correct: false, desc: '干扰项：需沸水' }
    ];
  } else {
    A = [
      ...
      { id: 'a5', text: '审评方法：柱形杯法（150mL审评杯）',          correct: false, desc: '干扰项：与所选盖碗不匹配' },
      { id: 'a6', text: '投茶量：3g',                                  correct: false, desc: '干扰项：3g为柱形杯法投茶量' },
      { id: 'a7', text: '只冲泡1次',                                   correct: false, desc: '干扰项：盖碗法需冲泡3次' },
      { id: 'a8', text: '水温：85℃冲泡',                               correct: false, desc: '干扰项：需沸水' }
    ];
  }
  ...
  var B = [
    ...
    { id: 'b2', text: method === 'cup' ? '杯盖留缝出汤' : '盖碗盖过滤出汤', correct: true, desc: '标准出汤动作' },
    { id: 'b3', text: '茶汤沥尽不残留',                                correct: true,  desc: '避免余汤影响浓度' },
    { id: 'b4', text: '用手直接抓取茶样',                              correct: false, desc: '干扰项：应用茶匙取茶' },
    { id: 'b5', text: '出汤留底约1/3',                                 correct: false, desc: '干扰项：留底导致浓度失真' },
    { id: 'b6', text: '冲泡时不计时',                                  correct: false, desc: '干扰项：必须严格计时' }
  ];
  ...
  var C = [
    ...
    { id: 'c4', text: '用审评杯/盖碗直接喝茶',                         correct: false, desc: '干扰项：应倒入品茗杯品饮' },
    { id: 'c5', text: '只嗅一次香气',                                  correct: false, desc: '干扰项：需热嗅+温嗅' },
    { id: 'c6', text: '叶底留在杯中不查看',                            correct: false, desc: '干扰项：必须倒出评叶底' }
  ];
